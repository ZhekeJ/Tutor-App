<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !description.isValid}">
      ...
      <textarea name="" id="description" rows="10" v-model.trim="description.val" @blur="clearValidity('description')"></textarea>
    ...
    <div class="form-control" :class="{invalid: !rate.isValid}">
      ...
      <p v-if="!rate.isValid"> Rate must be greater that 0 </p>
    </div>
